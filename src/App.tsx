      ...
      <header className="bg-white shadow-sm border-b-2 border-red-600" style={{ paddingTop: 'env(safe-area-inset-top)' }}>
        <div className="max-w-5xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          >
            ...
            <h1 className="text-xl font-bold text-gray-800">AUMA <span className="text-red-600">FLOW</span> <span className="text-[10px] font-normal text-red-400 align-top">v{APP_VERSION}</span></h1>
          </button>
          {selectedCustomer && (
