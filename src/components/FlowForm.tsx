      ...
      <div className="flex gap-1.5 items-stretch">
        ...
        {fieldImage ? (
          ...
          <button
            type="button"
            onClick={onUpload}
            className="w-11 h-11 rounded-md bg-red-600 flex items-center justify-center text-white shrink-0 cursor-pointer hover:bg-red-700 active:scale-95 transition-all shadow-sm"
          >
